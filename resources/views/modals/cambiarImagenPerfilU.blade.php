<div id="cambiarImagenPerfilUModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3 col-md-12 text-center ">
                    ...
                    @else
                    <img src="{{Auth::user()->imagen_url}}" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" width="200px" alt="">    
                    @endif
                   
                </div>  
                <form action="{{route('cambiar.imagen.perfilU')}}" method="POST" role="form" autocomplete="off" accept-charset="UTF-8" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
