...
@section('title') Base de Datos Niños Pendientes @endsection
@section('css')
...
@section('content')
    ...
    @slot('title') Base de Datos Niños   @endslot
                            ...
                            @foreach ($resultado as $fila)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-success btn-sm" href="{{route('perfil.hijo',['id'=>$fila->id])}}"><i class="fa fa-eye"></i></a>
