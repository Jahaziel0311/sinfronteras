<form action="{{route('form.insert')}}" method="POST" role="form" autocomplete="off" name="formulario" id="form-horizontal">
                    @csrf
                    ...
                    <fieldset>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-9" id="grupo__txtPrincipal__Pasaporte">
                                        <input id="txtPrincipal__Pasaporte" name="txtPrincipal__Pasaporte"
                                            type="text" class="form-control" onfocusout="valFormulario('grupo__txtPrincipal__Pasaporte','txtPrincipal__Pasaporte')" required>
                                            <i class="fa fa-times-circle validacion__estado"></i>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-9" id="grupo__txtPrincipal__Email">
                                        <input id="txtPrincipal__Email" name="txtPrincipal__Email"
                                            type="email" class="form-control" onfocusout="valFormulario('grupo__txtPrincipal__Email','txtPrincipal__Email')" required>
                                            <i class="fa fa-times-circle validacion__estado"></i>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 display__none" id="div__changes-estadoCivil">
                                <div class="mb-3 row " >
                                    <label for="txtFaxBilling"
                                        class="col-lg-3 col-form-label text-right">Conyuge / Pasaporte</label>
                                    <div class="col-lg-9" id="grupo__txtPrincipal__PasaporteConyuge">
                                        <input id="txtPrincipal__PasaporteConyuge" name="txtPrincipal__PasaporteConyuge" type="text"
                                            class="form-control">
                                            <i class="fa fa-times-circle validacion__estado"></i>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-9">
                                        <input id="txtPrincipal__FechaNacimiento" max="{{\Carbon\Carbon::now()->subYears(18)->format('Y-m-d')}}" name="txtPrincipal__FechaNacimiento" type="date"
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-12" id="grupo__txtPrincipal__Telefono">
                                        <input id="txtPrincipal__Telefono"
                                            ...
                                            class="form-control" onfocusout="valFormulario('grupo__txtPrincipal__Telefono','txtPrincipal__Telefono')" required>
                                            <i class="fa fa-times-circle validacion__estado"></i>
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3 row">
                                    <label for="txtCreditCardNumber"
                                        class="col-lg-3 col-form-label">Ocupación / Oficio</label>
                                    <div class="col-lg-9">
                                        <select name="txtPrincipal__Ocupacion" id="div__ocupacion" class="form-control" onchange="showElements('div__ocupacion','txtOcupacion__otra');">
